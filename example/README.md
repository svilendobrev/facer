...
* face__io.py	 : the declaration. run it to see documentation
* face4django.py: links (missing) implementation with django
* urls4django.py: then above into url-patterns
